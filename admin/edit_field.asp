...
if datatable<>"" then
	set rs=newdb.table(datatable).sel()
		...
		listdata=listdata&"<tr><td width='30%' align='right'><input name='auto_"&a.name&"' type='hidden' />"&a.name&"</td><td align='center' ><input type='text' name='"&a.name&"1' value='"&descr&"' /></td><td align='center' ><input type='text' name='"&a.name&"2' value='"&show&"' /></td></tr>"
		next
