...
Const Btn_First="<font>首页</font>"  '定义第一页按钮显示样式
Const Btn_Prev="<font>前一页</font>"  '定义前一页按钮显示样式
Const Btn_Next="<font>下一页</font>"  '定义下一页按钮显示样式
Const Btn_Last="<font>尾页&nbsp;</font>"  '定义最后一页按钮显示样式
